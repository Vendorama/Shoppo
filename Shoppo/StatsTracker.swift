...
struct APIRequest111 {
    // Core implementation: String id + optional extra query parameters.
    static func sendRequest(endpoint: String = "stats", id: String, extra: [String: String]? = nil) async {
    ...
    static func sendRequest<T: BinaryInteger>(endpoint: String = "stats", id: T, extra: [String: String]? = nil) async {
        await sendRequest(endpoint: endpoint, id: String(id), extra: extra)
    }

    // Overload: any floating-point id
    static func sendRequest<T: BinaryFloatingPoint>(endpoint: String = "stats", id: T, extra: [String: String]? = nil) async {
